    ...
    <div class="dash-content">
        ...
        <div class="row no-margin payment">
            <div class="col-md-12">
                ...
                <div class="pay-option" id="CASH">
                    <h6><img src="{{asset('asset/img/cash-icon.png')}}"> @lang('user.cash')
                    @if(Auth::user()->payment_mode == 'CASH')
                     <i class="fa fa-check" aria-hidden="true" style="color:green; margin-left: 588px;"></i>
                     @endif
                 </h6>

                </div>
                 <div class="pay-option" id="WAYFORPAY">
                    <h6><img src="{{asset('asset/img/card-icon.png')}}"> Way for pay 
                        @if(Auth::user()->payment_mode != 'CASH')
                        <i class="fa fa-check" aria-hidden="true" style="color:green; margin-left: 533px;"></i>
                        @endif
                    </h6>
    ...
    <script type="text/javascript">
        ...
        $('.pay-option').click(function(){
            ...
            $.ajax({
                ...
                type:'POST',
                data:{ '_token':csrf ,'payment_mode':$(this).attr("id")},
