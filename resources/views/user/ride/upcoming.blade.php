                        ...
                        <tr class="hiddenRow">
                            <td colspan="6">
                                <div class="accordian-body collapse row" id="trip_{{$trip->id}}">
                                    ...
                                    $static_map = "https://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=600x450&maptype=roadmap&format=png&visual_refresh=true&markers=icon:".$map_icon."%7C".$trip->s_latitude.",".$trip->s_longitude."&key=".Setting::get('map_key'); ?>
                                            ...
                                            <div class="from-to row no-margin">
                                                <div class="from">
                                                    <h5>@lang('user.ride.ride_details')</h5>
                                                    <p>{{$trip->s_address}}</p>
                                                </div>
                                            </div>
                                        </div>
