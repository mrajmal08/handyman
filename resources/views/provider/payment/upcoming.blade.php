...
<div class="pro-dashboard-head">
        <div class="container">
            <a href="{{url('provider/earnings')}}" class="pro-head-link">@lang('main.payment_statement')</a>
             <a href="{{url('provider/upcoming')}}" class="pro-head-link active">@lang('main.upcoming')</a>
                ...
                <div class="earning-section earn-main-sec pad20">
                    ...
                    <div class="earning-section-head row no-margin">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 no-left-padding">
                            <h3 class="earning-section-tit">@lang('main.upcoming') @lang('main.service')s</h3>
                        </div>
                    </div>
                            ...
                            <table class="earning-table table table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('main.vehicle')</th>
                                        <th>@lang('main.pickup_address')</th>
                                ...
                                @foreach($fully as $each)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="full-primary-btn fare-btn" onclick="return confirm('Are you sure?')"> Cancel</button>
                                        </form>
                                        </td>
                                    </tr>
                                @endforeach
