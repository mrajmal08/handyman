...
<div class="pro-dashboard-head">
        <div class="container">
            <a href="{{url('provider/earnings')}}" class="pro-head-link active">@lang('main.payment_statement')</a>
             <a href="{{url('provider/upcoming')}}" class="pro-head-link">@lang('main.upcoming')</a>
        ...
        <div class="earning-head">
            <div class="container">
                <div class="earning-element">
                    <p class="earning-txt">@lang('main.total_earning')</p>
                ...
                <div class="earning-element row no-margin">
                 ...
                 <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.service')s @lang('main.completed_today')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.daily') @lang('main.service') @lang('main.target') </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.fully_completed') @lang('main.service')s</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.acceptance_rate')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.provider') @lang('main.cancellations')</p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="earning-section pad20 row no-margin">
                    <div class="earning-section-head">
                        <h3 class="earning-section-tit">@lang('main.weekly_earnings')</h3>
                    </div>
                                ...
                                <div class="row no-margin">
                                    <div class="pull-left trip-left">
                                        <h3 data-toggle="collapse" data-target="#demo1" class="accordion-toggle collapsed acc-tit">
                                            <span class="arrow-icon fa fa-chevron-right"></span>@lang('main.service') @lang('main.earnings')
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="earning-section earn-main-sec pad20">
                    ...
                    <div class="earning-section-head row no-margin">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 no-left-padding">
                            <h3 class="earning-section-tit">@lang('main.daily_earnings')</h3>
                        </div>
                                    ...
                                    <form class="form-inline status-form">
                                        <div class="form-group">
                                            ...
                                            <select type="password" class="form-control mx-sm-3">
                                                ...
                                                <option>@lang('main.completed')</option>
                                                <option>@lang('main.pending')</option>
                                            </select>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="tab-content list-content">
                        <div class="list-view pad30 ">
                            ...
                            <table class="earning-table table table-responsive">
                                <thead>
                                    <tr>
                                        <th>@lang('main.pickup_time')</th>
                                        <th>@lang('main.booking_id')</th>
                                        <th>@lang('main.service_type')</th>
                                        <th>@lang('main.duration')</th>
                                        <th>@lang('main.status')</th>
                                        <th>@lang('main.distance')(KM)</th>
                                        <th>@lang('main.cash_collected')</th>
                                        <th>@lang('main.total_earnings')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php $fully_sum = 0; ?>
